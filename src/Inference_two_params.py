...
training_data_2_param = pd.read_csv('data/two_parameters_N_M_Uniformly_sampled_1M.csv')
#load the trained model
MODEL_PATH='models/Regressor_TwoParams_theta_nu_m_n.pth'
...
inputs = ['theta', 'nu', 'N', 'M']
X = training_data_2_param[inputs]
